package com.demo.webservices.restfulwebservices.exception;

import com.demo.webservices.restfulwebservices.user.UserNotFoundException;
...
// this class can be used by different controller class ex. UserResource
...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<Object> handleUserNoFoundException(UserNotFoundException ex, WebRequest request) throws java.lang.Exception {
	...
	// Error message when validation fails for Name and birthdate
	@Override
